...
def build_model(ent1, land1, ent2, land2):
    ...
    def add_kinematic_constraints(x, y, z, ux, uy, uz, entry, landing, prob):
        # boundary
        prob += (x[0] == entry["x"])
        prob += (y[0] == entry["y"])
        prob += (z[0] == entry["z"])
    ...
    add_kinematic_constraints(x1, y1, z1, ux1, uy1, uz1, ent1, land1, prob)
    add_kinematic_constraints(x2, y2, z2, ux2, uy2, uz2, ent2, land2, prob)
