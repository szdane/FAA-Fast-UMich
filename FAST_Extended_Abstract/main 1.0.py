...
def main():
    ...
    aircraft_list = [
        {"acId": "FFT3987_KMCOtoKDTW", "acType": "B737"},
        {"acId": "DAL8952_KPHLtoKDTW", "acType": "B737"}]
    ...
    df_csv = pd.read_csv("FAST_MILP_Evaluation/data/filtered_rows.csv",
    ...
    # 1.6 Serra's Optimized Waypoints, which includes entering and exiting location for pre-TRACON
    df_Serra_optWaypoints = pd.read_csv("FAST_MILP_Evaluation/data/trial3.csv")  # Load the flight data into pandaframe df
    ...
    for i, ac in enumerate(aircraft_list, start=1):
        ...
        middle_waypoints_cleaned = computation.waypoint_cleaning(
            ...
            lat0=dtw_lat, lon0=dtw_lon, threshold_deg=3
        )
        ...
        cruise_flight = Cruise_with_Multi_Waypoints(
            ...
            middle_alt_margin=200,  # altitude tolerance
